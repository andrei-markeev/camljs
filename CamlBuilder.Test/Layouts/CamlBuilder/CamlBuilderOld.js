...
CamlBuilder.Where.prototype = {
    ...
    BooleanField: function (internalName) {
        /// <summary>
        /// Specifies reference to the Boolean field with given internal name
        /// </summary>
        return new CamlBuilder.BooleanFieldRef(this.camlBuilder, name);
    },

    IntegerField: function (internalName) {
        /// <summary>
    ...
    NumberField: function (internalName) {
        /// <summary>
    ...
    CounterField: function (internalName) {
        /// <summary>
    ...
    TextField: function (internalName) {
        /// <summary>
    ...
    DateField: function (internalName) {
        /// <summary>
    ...
    DateTimeField: function (internalName) {
        /// <summary>
    ...
    UserField: function (internalName) {
        /// <summary>
        /// Specifies reference to the User field with given internal name
        /// </summary>
        return new CamlBuilder.LookupFieldRef(this.camlBuilder, name, "User");
    },

    LookupField: function (internalName) {
        /// <summary>
        /// Specifies reference to the Lookup field with given internal name
        /// </summary>
        return new CamlBuilder.LookupFieldRef(this.camlBuilder, name, "Lookup");
    },
...
// -------------------------------------------------------------------------------------------------------------------
CamlBuilder.LookupFieldRef = function (camlBuilder, name, valueType) {
    this.camlBuilder = camlBuilder;
    this.name = name;
...
CamlBuilder.LookupFieldRef.prototype = {
    Id: function() {
        return new CamlBuilder.FieldRef(this.camlBuilder, this.name, "Integer", true);
    },
    Value: function () {
        return new CamlBuilder.FieldRef(this.camlBuilder, this.name, this.valueType, false);
    },
    IsEqualToCurrentUserId: function () {
        this.camlBuilder.tree.push({ Element: 'FieldRef', Name: this.name, LookupId: true });
        CamlBuilder.BinaryOperator(this.camlBuilder, this.startIndex, "Eq", "Integer", CamlValues.UserID);
...
// -------------------------------------------------------------------------------------------------------------------
CamlBuilder.BooleanFieldRef = function (camlBuilder, name) {
    this.fieldRef = new CamlBuilder.FieldRef(camlBuilder, name, "Integer");
};
CamlBuilder.BooleanFieldRef.prototype = {
    IsTrue: function () {
        return this.fieldRef.IsEqualTo("1");
    },
    IsFalse: function () {
        return this.fieldRef.IsEqualTo("0");
    },
    IsNull: function () {
        return this.fieldRef.IsNull();
    },
    IsNotNull: function () {
        return this.fieldRef.IsNotNull();
    }
};
